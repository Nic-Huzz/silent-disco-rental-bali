...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Every rental includes: wireless headsets (with adjustable LED colors per channel), transmitter(s), aux cables, charging station, and delivery/pickup anywhere in Bali. Setup instructions are provided, and we offer support via WhatsApp throughout your event.",
    },
    {
    ...
    <section className="py-20 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="text-[#1400FF] font-semibold mb-2">Got Questions?</p>
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <svg
                  className={`w-5 h-5 text-[#1400FF] flex-shrink-0 transition-transform ${
        ...
        <div className="text-center mt-12">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-[#1400FF] font-semibold hover:underline"
          >
