        ...
        <section className="pt-28 pb-16 md:pt-36 md:pb-20 bg-gradient-to-b from-[#5e17eb]/10 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              <p className="text-[#5e17eb] font-semibold mb-3">Silent Disco Hire</p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {data.benefits.map((benefit, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-[#5e17eb]/10 rounded-full flex items-center justify-center mb-4">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {data.steps.map((step, index) => (
                <div key={index} className="text-center p-6 rounded-2xl bg-white shadow-lg">
                  <div className="w-16 h-16 bg-[#5e17eb] text-white rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold">
                    {index + 1}
                  </div>
        ...
        <section className="py-20 bg-gradient-to-br from-[#5e17eb] to-[#4a0ea8]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
              Send us a WhatsApp message with your event details and we&apos;ll get back to you with a custom quote.
            </p>
            <a
              href={whatsappUrl}
              target="_blank"
