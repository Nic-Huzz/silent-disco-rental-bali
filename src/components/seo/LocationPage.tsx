...
export default function LocationPage({ data }: { data: LocationPageData }) {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: isBali
        ? `We stock over 650 premium wireless headsets. Whether you need 20 for an intimate gathering or 650+ for a large event in ${data.location}, we've got you covered.`
